...
class _NutritionPageState extends State<NutritionPage> {
  ...
  void _calculateNutrition() {
    ...
    double height = double.tryParse(_heightCtrl.text) ?? 0; // height in feet
    ...
    // Calculate BMI (convert feet to meters: 1 foot = 0.3048 meters)
    ...
    // Calculate BMR (Mifflin-St Jeor) - convert feet to cm for formula
    double heightCm = height * 30.48; // 1 foot = 30.48 cm
    double bmr;
    if (_gender == 'Male') {
