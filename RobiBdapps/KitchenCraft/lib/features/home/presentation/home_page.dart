...
import 'package:KitchenCraft/features/settings/presentation/settings_page.dart';
...
import 'package:KitchenCraft/shared_list_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _logoutBdappsSession() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('isLoggedIn', false);
    await prefs.remove('userPhone');
    if (!mounted) return;
    setState(() {
      _isBdappsLoggedIn = false;
      _bdappsPhone = '';
    });
  }
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            if (isBdappsLoggedIn)
              Text(_bdappsPhone, style: const TextStyle(fontSize: 12, color: Colors.white70))
            else
              const Text('Guest Mode', style: TextStyle(fontSize: 12, color: Colors.white70)),
          ],
        ),
        actions: [
