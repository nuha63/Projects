...
class _AIChatPageState extends State<AIChatPage> {
  ...
  Future<void> _loadGroceryList() async {
    try {
      ...
      // Check if user is logged in (either way)
      ...
      // Load personal grocery items (collection: grocery) where userId == uid or phone
...
Details: $e''';
  ...
  Future<void> _sendQuery() async {
    ...
    try {
      ...
      // 3. Call the Groq API with the selected ingredients
