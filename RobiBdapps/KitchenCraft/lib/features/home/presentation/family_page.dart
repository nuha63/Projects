...
class _FamilyPageState extends State<FamilyPage> {
  ...
  Future<void> _createGroup() async {
    ...
    try {
      ...
      // Create/update user document with proper data
  ...
  Future<void> _joinGroup() async {
    ...
    final code = _groupCodeCtrl.text.trim().toUpperCase();
    if (code.isEmpty) {
    ...
    try {
      ...
      if (query.docs.isEmpty) {
        _showMessage("Group not found. Check the code and try again.");
        setState(() => _isLoading = false);
        return;
      }
      ...
      _showMessage("Successfully joined the group!");
    } catch (e) {
  ...
  Widget build(BuildContext context) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      Text(
                        'Login with your mobile number to create or join a family group and share recipes and grocery lists.',
                        style: TextStyle(
                          fontSize: 16,
    ...
    // For any logged-in user (Firebase or BDApps), show family UI
    return Scaffold(
      appBar: AppBar(
