...
class _ExpensePageState extends State<ExpensePage> {
  ...
  Future<void> _addExpense() async {
    ...
    _localBox.put('expenses', _localExpenses);
    ...
    if (user != null && user!.uid.isNotEmpty) {
      try {
        ...
        debugPrint('Firebase expense save failed: $e');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // For Firebase users - show Firestore expenses
    ...
    // For BDApps phone users - show local expenses with full UI
    return CustomScaffold(
