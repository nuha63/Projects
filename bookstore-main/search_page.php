...
if (!empty($_GET['search'])) {
  ...
  $sql = "SELECT * FROM `products` WHERE name LIKE '%$search_query%' OR type LIKE '%$search_query%' OR description LIKE '%$search_query%' ORDER BY created_at DESC";
  $search_results = mysqli_query($conn, $sql) or die('query failed');
}
?>
